...
public class Global {
    ...
    public static final int PLAYER_SPEED = 4; // px per frame; ~120 px/s
    public static final int PLAYER_SHOT_SPEED = 30; // px per frame a bullet travels
    public static final int PLAYER_SHOT_COOLDOWN = 80; // frames between shots (1.5s)
    ...
    public static final int STAGE_1_SECONDS = 120; // 3 minutes
    public static final int STAGE_2_SECONDS = 200; // 4 minutes  (7 minutes per full run)
    ...
    // Legacy Stage 2 (from gdd-space-invaders-project-stage2_1.zip), used only
    // by the standalone gdd.scene.Scene2 / gdd.legacy.Boss code path.
    public static final int STAGE2_DURATION_SECONDS = 200;
    public static final int STAGE2_BOSS_HP = BOSS_HP * 2;
    public static final int[] STAGE2_BOSS_SPAWN_SECONDS = {40, 100, 170};
    public static final int SHIELD_DURATION_FRAMES = 240; // 4s of invincibility
    ...
    public static final int PLANE_GAP_START = 210; // frames between planes at zero pressure
    public static final int PLANE_GAP_END = 130;    // ...and at full pressure
